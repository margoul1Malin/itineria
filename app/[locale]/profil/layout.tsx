...
export default function ProfilLayout({
  ...
  const navigation = [
    {
      name: t('navigation.personalInfo'),
      href: `/${locale}/profil/infos`,
      icon: (
    ...
    },
    {
      ...
      href: `/${locale}/profil/preferences`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      href: `/${locale}/profil/notifications`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: t('navigation.paymentMethods'),
      href: `/${locale}/profil/paiement`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      href: `/${locale}/profil/confidentialite`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('loadingError')}</h2>
          <p className="text-gray-600">{t('cannotLoadProfile')}</p>
        </div>
      </div>
    )
  }
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-stone-200 mb-4">{t('memberSince')} {userDisplayData.memberSince}</p>
                <div className="flex flex-wrap gap-6 justify-center md:justify-start">
                  <div className="text-center">
                    <div className="text-2xl font-bold">{userDisplayData.totalTrips}</div>
                    <div className="text-sm text-stone-200">{t('trips')}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold">{userDisplayData.totalReviews}</div>
                    <div className="text-sm text-stone-200">{t('reviews')}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold">{userDisplayData.favoriteDestinations.length}</div>
                    <div className="text-sm text-stone-200">{t('favorites')}</div>
                  </div>
                </div>
              </div>
            </div>

    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto z-20">
          ...
          <form onSubmit={handleSubmit} className="form-container rounded-2xl p-4 md:p-8 mb-8">
            {/* Type de voyage */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
              ...
              <div className="origin-dropdown-container relative">
                <label className="block text-sm font-semibold text-green-800 mb-2">{t('from')}</label>
                <input
                  type="text"
                  placeholder={t('from')}
              ...
              <div className="destination-dropdown-container relative">
                <label className="block text-sm font-semibold text-green-800 mb-2">{t('to')}</label>
                <input
                  type="text"
                  placeholder={t('to')}
              ...
              <div className="lg:col-span-2 calendar-container">
                <label className="block text-sm font-semibold text-green-800 mb-2">{t('dates')}</label>
                <button
                  type="button"
                ...
                >
                  {searchForm.departureDate ? (
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-gray-500">{t('selectDates')}</span>
                      <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6">
              ...
              <div className="lg:col-span-3">
                <label className="block text-sm font-semibold text-green-800 mb-2">{t('passengers')}</label>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                                      <div className="bg-gray-50 p-3 md:p-4 rounded-lg border border-gray-200">
                      <label className="block text-xs font-medium text-gray-700 mb-2">{t('adults')} (18+)</label>
                    <select
                  ...
                  <div className="bg-gray-50 p-3 md:p-4 rounded-lg border border-gray-200">
                    <label className="block text-xs font-medium text-gray-700 mb-2">{t('children')} (2-17)</label>
                    <select
                  ...
                  <div className="bg-gray-50 p-3 md:p-4 rounded-lg border border-gray-200">
                    <label className="block text-xs font-medium text-gray-700 mb-2">{t('infants')} (0-1)</label>
                    <select
              ...
              {/* Classe */}
              <div>
                <label className="block text-sm font-semibold text-green-800 mb-2">{t('class')}</label>
                <div className="bg-gray-50 p-3 md:p-4 rounded-lg border border-gray-200">
                  <label className="block text-xs font-medium text-gray-700 mb-2">{t('class')}</label>
                  <select
          ...
          <div className="max-w-7xl mx-auto space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-8 bg-gradient-to-br from-green-50 to-green-100 rounded-2xl border border-green-200 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-2xl font-semibold text-green-800 mb-3">{t('destinations500')}</h3>
                <p className="text-gray-600 leading-relaxed">{t('flyWorldwide')}</p>
              </div>
              ...
              <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl border border-blue-200 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-2xl font-semibold text-blue-800 mb-3">{t('guaranteedPrices')}</h3>
                <p className="text-gray-600 leading-relaxed">{t('noHiddenFees')}</p>
              </div>
              ...
              <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl border border-purple-200 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-2xl font-semibold text-purple-800 mb-3">{t('secureBooking')}</h3>
                <p className="text-gray-600 leading-relaxed">{t('protectedPayment')}</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-10 text-center text-white shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <div className="flex items-center gap-3 bg-white/10 rounded-xl px-6 py-3 hover:bg-white/20 transition-colors">
                  ...
                  <span className="font-medium">{t('instantSearch')}</span>
                </div>
                <div className="flex items-center gap-3 bg-white/10 rounded-xl px-6 py-3 hover:bg-white/20 transition-colors">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span className="font-medium">{t('totalFlexibility')}</span>
                </div>
                <div className="flex items-center gap-3 bg-white/10 rounded-xl px-6 py-3 hover:bg-white/20 transition-colors">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {metadata && !isLoading && (
                <aside className="w-full lg:w-80 lg:flex-shrink-0 order-1 lg:order-none">
                  <div className="lg:sticky lg:top-4 bg-gray-50 rounded-xl p-4 md:p-6 max-h-96 lg:max-h-screen overflow-y-auto">
                    <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-4 md:mb-6">{t('filters')}</h3>
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        >
                          <option value="price">{t('priceLowest')}</option>
                          <option value="duration">{t('durationShortest')}</option>
                          <option value="departure">{t('departureTime')}</option>
                        </select>
                      </div>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          {t('priceRange')}: {filters.priceRange.min}€ - {filters.priceRange.max}€
                        </label>
                      ...
                      {/* Type de vol */}
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t('flightType')}</label>
                        <select 
                        ...
                        >
                          ...
                          <option value="stops">{t('withStops')}</option>
                        </select>
                      </div>

                      {/* Heure de départ */}
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t('departureTimeRange')}</label>
                      ...
                      {searchForm.tripType === 'roundtrip' && (
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">{t('returnTimeRange')}</label>
                          <div className="flex gap-2">
                            <input
                              type="time"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">{t('airlines')}</label>
              ...
              <div className="flex-1 order-2 lg:order-none">
                <div className="text-center mb-6 md:mb-8">
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-green-800 mb-4">
                    {isLoading ? t('searching') : `${t('results')} (${filteredFlights.length} vols)`}
                  </h2>
                      ...
                      <div key={flight.id} className="bg-white rounded-xl shadow-lg border border-gray-200 p-4 md:p-6 hover:shadow-xl transition-shadow">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                            ...
                            <div className="text-sm text-gray-600">
                              {flight.slices.length === 2 ? t('roundTrip') : t('oneWay')}
                            </div>
                          </div>
                            ...
                            <div key={sliceIndex} className="border border-gray-100 rounded-lg p-3 md:p-4">
                              <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-3">
                                <h4 className="font-semibold text-base md:text-lg text-black">
                                  {sliceIndex === 0 ? t('departure') : t('return')}: {slice.segments[0].originName} → {slice.segments[slice.segments.length - 1].destinationName}
                                </h4>
                                <div className="text-xs md:text-sm text-black font-bold">
                                   {t('duration')}: {formatDuration(calculateSliceDuration(slice))}
                                   {slice.hasStops && <span className="ml-2 text-orange-600">({slice.segments.length - 1} {slice.segments.length > 2 ? t('stops') : t('stop')})</span>}
                                 </div>
                              </div>

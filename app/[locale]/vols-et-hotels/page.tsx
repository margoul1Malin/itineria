  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 to-green-50">
      ...
      <section className="py-20 bg-white">
        ...
        {/* Carousel infini pour les offres sur toute la largeur */}
        <div className="relative overflow-hidden">
          <div className="flex animate-scroll-infinite">
            {/* Premier set d'offres */}
            {offers.map((offer) => (
              <div key={`first-${offer.id}`} className="flex-shrink-0 w-80 mx-4 group cursor-pointer">
            ...
            {offers.map((offer) => (
              <div key={`second-${offer.id}`} className="flex-shrink-0 w-80 mx-4 group cursor-pointer">
                <div className="relative overflow-hidden rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  <div className="aspect-[4/3] relative">
                    <Image
                      src={offer.image}

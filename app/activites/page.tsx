...
export default function Activites() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 to-green-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 pb-8">
        ...
        <div className="relative z-20 text-center text-white px-4 w-full max-w-6xl">
          ...
          <p className="text-lg md:text-2xl mb-6 md:mb-8 max-w-2xl mx-auto">
            Découvrez des expériences uniques et des activités inoubliables
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-transparent text-black">
                  ...
                  <option>Visites guidées</option>
                  <option>Sports & Aventure</option>
                  <option>Culture & Histoire</option>
                  <option>Gastronomie</option>
                  <option>Nature & Plein air</option>
                </select>
              </div>
              <div>
              ...
              <div>
                <label className="block text-sm font-semibold text-green-800 mb-2">Durée</label>
                <select className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-transparent text-black">
                  <option>Toutes durées</option>
                  <option>1-2 heures</option>
                  <option>3-4 heures</option>
      ...
      {/* Activités En Vogue Section */}
      <section className="py-20 px-4 bg-gradient-to-br from-stone-50 to-green-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-green-800 mb-4">Activités En Vogue</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Découvrez nos activités les plus populaires et créez des souvenirs inoubliables
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-green-800 mb-4">Recherche Avancée d&apos;Activités</h2>
          <p className="text-lg text-gray-600 mb-8">
            Utilisez nos filtres avancés pour trouver l&apos;activité parfaite selon vos envies
          </p>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Profitez de nos réductions exceptionnelles sur une sélection d&apos;activités
            </p>
          </div>
